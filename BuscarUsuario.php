...
<!--
Author: Joel Elisaú Ignacio Herrera, Freddy Velasco Hernandez
...
<html>
<head>
<title>Consultorio ULV : Buscar Usuario</title>
...
<!----->
       ...
       <div class="content-main">
        ...
        <div class="validation-form">
        	<h3 id="forms-example" class="">Buscar Usuario</h3>
			<form action="Usuarios.php" method="get">
            <div class="col-md-4 form-group1">
            <label class="control-label">Nombre</label>
            <input name="nombre" type="text" placeholder="Aquí escribe el nombre">
            </div>
