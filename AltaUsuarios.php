...
<!-- Este codigo PHP es para la sesion -->
<?php
if (!isset($_SESSION)) {
  session_start();
}
...
?>
<!-- Aqui se hace la inserción y consultas -->
<?php
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO usuarios (nombre, apellidos, usuario, contrasena, imagen) VALUES (%s, %s, %s, %s, %s)",
...
<!----->
    ...
    <div class="validation-system">
    <div class="validation-form">
    <h3 id="forms-example" class="">Registrar Usuario</h3>
      ...
      <table align="center">
        <tr valign="baseline">
          <div class="col-md-6 form-group1">
              ...
              <input type="text" name="nombre" value="" placeholder="Escribe tu nombre">
            </div>
        </tr>
        <tr valign="baseline">
           <div class="col-md-6 form-group1 form-last">
              <label class="control-label">Apellidos</label>
              <input type="text" name="apellidos" value="" placeholder="Escribe tus apellidos">
            </div>
        </tr>
        <tr valign="baseline">
           <div class="col-md-6 form-group1">
              <label class="control-label">Usuario</label>
              <input type="text" name="usuario" value="" placeholder="Escribe tu usuario">
            </div>
        </tr>
        <tr valign="baseline">
           <div class="col-md-6 form-group1">
              <label class="control-label">Contraseña</label>
              <input type="password" name="contrasena" value="" placeholder="Escribe tu contraseña">
            </div>
        </tr>
