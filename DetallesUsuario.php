...
$query_qUsuario = sprintf("SELECT nombre, apellidos, usuario, imagen FROM usuarios WHERE idusuario = %s", GetSQLValueString($colname_qUsuario, "int"));
...
<html>
<head>
<title>Consultorio ULV : Principal</title>
...
<!----->
       ...
       <div class="content-main">
  		...
  		<!-- Muestras la informacion del usuario seleccionado -->
		<div class="content-top">
			
           <div class="middle-content">
           			<h3 id="forms-example" class="">Detalles Usuario</h3>
					<h4><?php echo $row_qUsuario['nombre']; ?> <?php echo $row_qUsuario['apellidos']; ?></h4>
                    
                    <h5>Usuario: <?php echo $row_qUsuario['usuario']; ?> </h5>
					<!-- start content_slider -->
		<div id="owl-demo" class="owl-carousel text-center owl-theme" style="opacity: 1; display: block;">
			<div class="owl-wrapper-outer"><div class="owl-wrapper" style="width: 1876px; left: 0px; display: block; transition: all 1000ms ease; transform: translate3d(0px, 0px, 0px);"><div class="owl-item" style="width: 134px;"><div class="item">
				<img class="lazyOwl img-responsive" alt="name" src="uploads/<?php echo $row_qUsuario['imagen']; ?>" style="display: block;">
			</div></div><div class="owl-item" style="width: 134px;"><div class="item">
